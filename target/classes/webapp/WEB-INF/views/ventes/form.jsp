...
<head>
    ...
    <title>${vente != null ? 'Modifier' : 'Ajouter'} une vente - E-Commerce</title>
        ...
        <div class="row">
            ...
            <div class="col-md-10 p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="fw-bold">${vente != null ? 'Modifier' : 'Ajouter'} une vente</h2>
                    <div>
                        <a href="/ventes" class="btn btn-outline-secondary">Retour</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="${vente != null ? '/ventes/update' : '/ventes/save'}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="productId" name="productId" 
                                           value="${vente != null ? vente.productId : ''}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="quantity" class="form-label">Quantité</label>
                                    <input type="number" step="0.01" class="form-control" id="quantity" name="quantity" 
                                           value="${vente != null ? vente.quantity : '0'}" required>
                                </div>
                            </div>
                            
                            <div class="mb-3">
                                <label for="dateP" class="form-label">Date de vente</label>
                                <input type="datetime-local" class="form-control" id="dateP" name="dateP" 
                                       value="${vente != null ? vente.dateP : ''}" required>
                            </div>
                            
                            <div class="d-flex justify-content-end gap-2">
                                <a href="/ventes" class="btn btn-secondary">Annuler</a>
